...
import { type CartItem, getCart, removeCartItem, updateCartItemQty } from "@/lib/api/cart";
                  ...
                  (() => {
                    ...
                    return (
                      <div
                        key={item.id}
                        className={cn(
                          "relative flex gap-4 p-4 bg-card rounded-xl border border-border",
                        )}
                      >
                        <div
                          className={cn(
                        ...
                        <div className="flex flex-col items-end justify-between relative z-20">
                          ...
                          >
                            <button
                              ...
                              onClick={() =>
                                updateQtyMutation.mutate({ itemId: item.id, qty: item.qty - 1 })
                              }
                ...
                <div className="bg-card border border-border rounded-xl p-6 sticky top-24">
                  ...
                  {unavailableItems.length > 0 && (
                    <div className="mb-4 rounded-xl border border-amber-200 bg-amber-50 p-4 text-sm text-amber-900">
                      Some items are unavailable. Sold out items are excluded from totals. Please
                      update quantities or remove them to proceed.
                    </div>
                  )}
