...
const serverSchema = {
  ...
  CREDO_ZERO_MERCHANT_ID: z.string().optional(),
  ...
  CUSTOM_CHECKOUT_PASS: z.string().optional(),
...
const runtimeEnv: RuntimeEnv = {
  ...
  CREDO_ZERO_MERCHANT_ID: process.env.CREDO_ZERO_MERCHANT_ID,
  ...
  CUSTOM_CHECKOUT_PASS: process.env.CUSTOM_CHECKOUT_PASS,
